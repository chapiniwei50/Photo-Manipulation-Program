...
public class Pixel implements Comparable<Pixel> {
     ...
     */
    public int getRed() {
        return this.red; // Implement this method
    }
     ...
     */
    public int getGreen() {
        return this.green; // Implement this method
    }
     ...
     */
    public int getBlue() {
        return this.blue; // Implement this method
    }
    ...
    public int[] getComponents() {
        ...
        array[1] = this.green;
        array[2] = this.blue;
        return array; // Implement this method
    }
    ...
    public int distance(Pixel px) {
        if (px == null) {
            ...
            return (Math.abs(this.red - px.getRed()) + Math.abs(this.green - px.getGreen())
                     + Math.abs(this.blue - px.getBlue()));
        }
    }
    ...
    public boolean equals(Pixel px) {
        ...
        return ((this.red == px.getRed()) && (this.green == px.getGreen()) &&
                (this.blue == px.getBlue())); // Implement this method
    }
